...
static const struct command commands[] = {
    ...
    { "combine-sink-add-output", pa_cli_command_combine_sink_add_output, "Add a output sink to the specified combine sink (args: index|name, index|name", 3},
    { "combine-sink-del-output", pa_cli_command_combine_sink_del_output, "Delete a output sink from the specified combine sink (args: index|name, index|name", 3},
